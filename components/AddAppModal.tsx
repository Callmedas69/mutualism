      ...
      <DialogContent showCloseButton={false} className="sm:max-w-md">
        ...
        <DialogFooter className="flex-col gap-2">
          <button
            ...
            disabled={isAdding}
            className="w-full px-6 py-3 text-sm font-medium bg-zinc-900 text-white rounded-lg hover:bg-zinc-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100 flex items-center justify-center gap-2"
          >
            {isAdding ? (
              <>
