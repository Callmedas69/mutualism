...
export default function AuthGate({ children }: AuthGateProps) {
  ...
  if (!user) {
    // Miniapp: Return null - Farcaster splash + ConnectionTabs loading handles it
    // This prevents the flash of AuthGate spinner before "Finding your people..."
    if (isMiniApp) {
      return null;
    }

    // Web: Show auth required UI with sign-in button
    return (
