  ...
  return (
    <>
      <button
        ...
        className={`flex items-center justify-center gap-2 border border-[#f25b28] bg-orange-50 px-3 py-2 min-h-[36px] text-[10px] font-medium uppercase tracking-[0.1em] text-[#f25b28] whitespace-nowrap transition-all duration-200 hover:border-[#d94d1f] hover:bg-orange-100 hover:text-[#d94d1f] disabled:cursor-not-allowed disabled:border-zinc-300 disabled:bg-zinc-100 disabled:text-zinc-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f25b28] dark:border-[#f25b28] dark:bg-orange-950/50 dark:text-orange-300 dark:hover:border-orange-400 dark:hover:text-orange-100 dark:disabled:border-zinc-700 dark:disabled:bg-zinc-800 dark:disabled:text-zinc-500 ${fullWidth ? "w-full" : "min-w-[100px]"}`}
      >
        {isGated ? "Share First" : "Zora Post"}
      </button>
